...
if "page" not in st.session_state:
    st.session_state.page = "ResumeUploadPage"
# ─────────────────────────────────────────────
# Helper Functions 
# ─────────────────────────────────────────────
...
# ─────────────────────────────────────────────
if st.session_state.page == "ResumeUploadPage":
    ...
    pages = {
        "Resume": [
            st.Page("user_interface.py", title="Score Resume")
        ], 
        "Cover Letter": [
            st.Page("letter_score.py",title="Get Score"),
            st.Page("test.py",title="Generate Cover Letter")
        ]
    }
